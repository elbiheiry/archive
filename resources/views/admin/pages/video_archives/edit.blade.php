            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form action="{{route('admin.videos.edit' ,['id' => $archive->id])}}" method="post" enctype="multipart/form-data" onsubmit="return false;">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="video" value="{{$archive->video}}" class="form-control">
