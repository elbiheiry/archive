            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form action="{{route('admin.images')}}" method="post" enctype="multipart/form-data" onsubmit="return false;">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="file_number" value="Image{{rand(1 , 999)}}-{{\Carbon\Carbon::now()->format('d-m-Y')}}" readonly>
